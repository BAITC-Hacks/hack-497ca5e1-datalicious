...
**Состояние: обзор города и выбор решений.** Есть адаптивный интерфейс,
исходный датасет, каталог 14 мер, выбор пяти решений с контролем ограничений,
бюджет, синергии и ручное сохранение плана в браузере.
...
Единственный smoke проверяет выбор контрольного набора на 95 единиц,
сохранение и восстановление после перезагрузки, отсутствие горизонтальной
прокрутки на телефоне и ноутбуке и заглушку API, без API-ключа.
