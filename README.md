...
**Состояние: общий каркас.** Есть стартовая страница, исходный датасет,
общие контракты, серверная фабрика OpenAI SDK и инфраструктура тестов.
Выбор решений, валидатор, расчёт Score, графики и AI-анализ предстоит реализовать.
